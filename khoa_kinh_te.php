...
<body>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="sach_kinh_te.php">Khoa kinh tế</a></li>
            </ol>
        </div>
    </section>
    ...
    <section class="banner">
        <div class="container">
            <a href="sach-moi-tuyen-chon.html"><img src="images/Welcome to Mathematics Google Classroom Header (11) - Copy.png" alt="banner-sach-ktkn"
                    class="img-fluid"></a>
        </div>
    </section>
    <!-- khối sản phẩm  -->
