                ...
                <div class="col-lg-3 col-md-5">
                    <div class="categoryheader">
                        ...
                        <div class="categorycontent">
                            <ul>
                                <li> <a href="khoa_ly_luan_chinh_tri">Khoa lý luận chính trị</a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>

                                <li><a href="khoa_ngan_hang">Khoa ngân hàng </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                                 <li><a href="khoa_luat">Khoa luật </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                                <li><a href="khoa_ke_kiem">Khoa kế - kiểm </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                                <li><a href="khoa_htttql">Khoa HTTTQL </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                                <li><a href="khoa_tai_chinh">Khoa tài chính </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                                <li><a href="bo_mon_toan">Bộ môn toán </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                                <li><a href="khoa_ngon_ngu_anh">Khoa ngôn ngữ Anh </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                                <li><a href="khoa_quan_tri_kinh_doanh">Khoa quản trị kinh doanh </a><i
                                        class="fa fa-chevron-right float-right"></i>
                                </li>
                        ...
                        <div class="row">
                                ...
                                <div class="soluong d-flex">
                                    ...
                                    <div class="input-number input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <input type="submit" name="addcart" value="Chọn mua" class="nutmua btn w-100 text-uppercase">
                            ...
                            <div class="uudai my-3">
                                <div class="header font-weight-bold">
                                    <ul>
                                        <li>Tác giả: <?php echo $row["tac_gia"];?> </li>
                                        <li>Ngày xuất bản: <b><?php echo date("d/m/Y", strtotime($row["ngay_xuat_ban"]));?></b></li>
                                        <li>Nhà xuất bản:<?php echo $row["nha_xuat_ban"];?>  </li>
