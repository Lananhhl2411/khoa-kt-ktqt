...
<body>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="sach_kinh_te.php">Khoa kinh doanh quốc tế</a></li>
            </ol>
        </div>
    </section>
    ...
    <section class="banner">
        <div class="container">
            <a href="sach-moi-tuyen-chon.html"><img src="images/Welcome to Mathematics Google Classroom Header (9).png" alt="banner-sach-ktkn"
                    class="img-fluid"></a>
        </div>
    </section>
    <!-- khối sản phẩm  -->
                ...
                <div class="items">
                    <div class="row">
                                               ...
                                               $sql="SELECT * 
                                                    ...
                                                    WHERE `ten_khoa`=N'khoa kinh doanh quốc tế'";
                                                ...
                                                ;?>
                                                 <div class="col-lg-3 col-md-4 col-xs-6 item DeanGraziosi">
                                                    ...
                                                    <div class="card-body noidungsp mt-3">
                                                        <h6 style="text-align: center;" class="card-title ten"><a href="chi_tiet_san_pham.php?id=<?php echo $row['san_pham_id'];?>"><?php echo $row["ten_san_pham"];?></h6>
